...
public enum StochasticSolverStepSize {
    CONSTANT {
        ...
        public double compute(int iteration, double... parameters) {
            ...
            if (parameters.length > 1) {
                System.out.println("Only one parameter is needed for this method. The rest will be ignored.");
            }
            return parameters[0];
        }
    },
    SCALED {
        ...
        public double compute(int iteration, double... parameters) {
            ...
            if (parameters[0] < 0) {
                throw new IllegalArgumentException("The value of the tau parameter (i.e. parameters[0]) " +
                                                           "must be >= 0.");
            }
