...
public final class ConjugateGradientSolver extends AbstractIterativeSolver {
    ...
    protected static abstract class AbstractBuilder<T extends AbstractBuilder<T>>
        ...
        public AbstractBuilder(makina.optimization.function.QuadraticFunction objective, Vector initialPoint) {
    ...
    public static class Builder extends AbstractBuilder<Builder> {
        public Builder(makina.optimization.function.QuadraticFunction objective,
                       Vector initialPoint) {
            super(objective, initialPoint);
        }
    ...
    private ConjugateGradientSolver(AbstractBuilder<?> builder)
        ...
        if (objective instanceof LinearLeastSquaresFunction) {
            ...
            temporaryA = ((makina.optimization.function.QuadraticFunction) objective).getA();
            b = ((makina.optimization.function.QuadraticFunction) objective).getB();
        }
