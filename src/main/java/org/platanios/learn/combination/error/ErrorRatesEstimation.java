...
public class ErrorRatesEstimation {
     ...
     * {@link DependencyObjectiveFunction} as the objective function we wish to
     * minimize, and initializes the numerical optimization solver that is used to solve it. That solver is currently
     * the KNITRO solver.
     *
     * @param   data    A data structure ({@link EstimationData}) which contains
     ...
     *
     * @param   data                    A data structure ({@link EstimationData})
