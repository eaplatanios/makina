...
public class Vectors {
     ...
     * @throws  IOException
     */
    public static DenseVector dense(ObjectInputStream inputStream) throws IOException {
     ...
     * must have been written using the
     * {@link org.platanios.learn.math.matrix.SparseVector#writeToStream(java.io.ObjectOutputStream)} method in order to
     * be compatible with this constructor. If the contents are not compatible, then an {@link java.io.IOException}
     ...
     * @throws  IOException
     */
    public static SparseVector sparse(ObjectInputStream inputStream) throws IOException {
    ...
    public static HashVector hash(ObjectInputStream inputStream) throws IOException {
