...
// */
//public class FeatureMapMySQLTest {
//    @Test
...
//        FeatureMapMySQL<DenseVector> featureMap =
//                (FeatureMapMySQL<DenseVector>) FeatureMap.Type.MY_SQL.<DenseVector>build(3);
...
//        Assert.assertTrue(featureMap.features("apple", 0) == null);
//        Assert.assertTrue(featureMap.features("apple", 1).equals(appleView1Vector));
//        Assert.assertTrue(featureMap.features("apple", 2).equals(appleView2Vector));
//        Assert.assertTrue(featureMap.features("orange", 0).equals(orangeView0Vector));
//        Assert.assertTrue(featureMap.features("orange", 1).equals(orangeView1Vector));
//        Assert.assertTrue(featureMap.features("orange", 2) == null);
//    }
//
//    @Test
