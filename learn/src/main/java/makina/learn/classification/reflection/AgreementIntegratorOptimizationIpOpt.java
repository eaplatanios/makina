...
import makina.math.CombinatoricsUtilities;
...
final class AgreementIntegratorOptimizationIpOpt extends Ipopt implements AgreementIntegratorOptimization {
     ...
     * variables. */
    private final AgreementIntegratorObjective.Function objectiveFunction;
     ...
     *                                  dependency, etc.).
     */
    AgreementIntegratorOptimizationIpOpt(int numberOfFunctions,
                                         int highestOrder,
