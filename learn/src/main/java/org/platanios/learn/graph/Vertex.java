...
public class Vertex<V, E> {
    ...
    public void computeUpdatedContent(TriFunction<V, Set<Edge<V, E>>, Set<Edge<V, E>>, V> computeFunction) {
        updatedContent = computeFunction.apply(content, incomingEdges, outgoingEdges);
    }
