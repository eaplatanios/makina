 ...
 */
public enum ErrorEstimationInternalSolver {
    /** Uses the IpOpt solver. */
    IP_OPT {
        /** {@inheritDoc} */
        @Override
        public ErrorEstimationOptimization buildOptimizationProblem(int numberOfFunctions,
                                                                    int highestOrder,
                                                                    ErrorRatesPowerSetVector errorRates,
                                                                    AgreementRatesPowerSetVector agreementRates,
                                                                    ErrorEstimationObjective objective) {
            return new ErrorEstimationOptimizationIpOpt(numberOfFunctions,
                                                        highestOrder,
                                                        errorRates,
                                                        agreementRates,
                                                        objective);
    ...
    KNITRO {
        ...
        public ErrorEstimationOptimization buildOptimizationProblem(int numberOfFunctions,
                                                                    ...
                                                                    AgreementRatesPowerSetVector agreementRates,
                                                                    ErrorEstimationObjective objective) {
            return new ErrorEstimationOptimizationKNITRO(numberOfFunctions,
                                                         highestOrder,
                                                         errorRates,
                                                         agreementRates,
                                                         objective);
     ...
     */
    public abstract ErrorEstimationOptimization buildOptimizationProblem(int numberOfFunctions,
                                                                         int highestOrder,
                                                                         ErrorRatesPowerSetVector errorRates,
                                                                         AgreementRatesPowerSetVector agreementRates,
                                                                         ErrorEstimationObjective objective);
