        ...
        for (ProbabilisticSoftLogicProblem.GroundingMode groundingMode : ProbabilisticSoftLogicProblem.GroundingMode.values()) {
            ...
            if (false) { // (outputStreamFile.exists()) {
                ...
                try (
                    ...
                    ProbabilisticSoftLogicReader.readGroundingsAndAddToManager(
                            trainPredicateManager, logicManager, personType, "KNOWS", groundingMode == ProbabilisticSoftLogicProblem.GroundingMode.AllPossible, false, knowsReader);

                    ProbabilisticSoftLogicReader.readGroundingsAndAddToManager(
                            trainPredicateManager, logicManager, personType, "TRUSTS", false, false, trustTrainReader);
