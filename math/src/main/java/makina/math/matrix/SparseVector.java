 ...
 */
public class SparseVector extends makina.math.matrix.Vector {
    ...
    public void set(int initialIndex, int finalIndex, makina.math.matrix.Vector vector) {
        if (initialIndex < 0 || initialIndex >= size || finalIndex < 0 || finalIndex >= size) {
            throw new IllegalArgumentException(
                    "The provided indexes must be between 0 (inclusive) and the size of the vector (exclusive)."
            );
    ...
    /** {@inheritDoc} */
    @Override
    public void set(int[] indexes, makina.math.matrix.Vector vector) {
        for (int i = 0; i < indexes.length; i++) {
    ...
    /** {@inheritDoc} */
    @Override
    public void set(makina.math.matrix.Vector vector) {
    ...
    /** {@inheritDoc} */
    @Override
    public makina.math.matrix.Vector maxElementwise(double value) {
    ...
    /** {@inheritDoc} */
    @Override
    public makina.math.matrix.Vector maxElementwiseInPlace(double value) {
        if (Double.compare(value, 0) == 0) {
	        for (int i = 0; i < this.values.length; i++) {
    ...
    /** {@inheritDoc} */
    @Override
    public makina.math.matrix.Vector maxElementwise(makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        throw new UnsupportedOperationException();
    }
    ...
    /** {@inheritDoc} */
    @Override
    public makina.math.matrix.Vector maxElementwiseInPlace(makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        throw new UnsupportedOperationException();
    }
    ...
    /** {@inheritDoc} */
    @Override
    public makina.math.matrix.Vector minElementwise(double value) {
        throw new UnsupportedOperationException();
    }

    /** {@inheritDoc} */
    @Override
    public makina.math.matrix.Vector minElementwiseInPlace(double value) {
        throw new UnsupportedOperationException();
    }

    /** {@inheritDoc} */
    @Override
    public makina.math.matrix.Vector minElementwise(makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        throw new UnsupportedOperationException();
    }
    ...
    /** {@inheritDoc} */
    @Override
    public makina.math.matrix.Vector minElementwiseInPlace(makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        throw new UnsupportedOperationException();
    }
    ...
    /** {@inheritDoc} */
    @Override
    public SparseVector add(makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
    ...
    /** {@inheritDoc} */
    @Override
    public SparseVector addInPlace(makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        if (vector.type() == VectorType.SPARSE) {
            int[] newIndexes = new int[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
            double[] newValues = new double[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
    ...
    /** {@inheritDoc} */
    @Override
    public SparseVector sub(makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        SparseVector resultVector;
        if (vector.type() == VectorType.SPARSE) {
            int[] newIndexes = new int[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
    ...
    /** {@inheritDoc} */
    @Override
    public SparseVector subInPlace(makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        if (vector.type() == VectorType.SPARSE) {
            int[] newIndexes = new int[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
            double[] newValues = new double[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
    ...
    /** {@inheritDoc} */
    @Override
    public SparseVector multElementwise(makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        SparseVector resultVector;
        if (vector.type() == VectorType.SPARSE) {
            int[] newIndexes = new int[numberOfNonzeroEntries];
    ...
    /** {@inheritDoc} */
    @Override
    public SparseVector multElementwiseInPlace(makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        if (vector.type() == VectorType.SPARSE) {
            int[] newIndexes = new int[numberOfNonzeroEntries];
            double[] newValues = new double[numberOfNonzeroEntries];
    ...
    /** {@inheritDoc} */
    @Override
    public SparseVector divElementwise(makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        SparseVector resultVector;
        if (vector.type() == VectorType.SPARSE) {
            int[] newIndexes = new int[numberOfNonzeroEntries];
    ...
    /** {@inheritDoc} */
    @Override
    public SparseVector divElementwiseInPlace(makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        if (vector.type() == VectorType.SPARSE) {
            int[] newIndexes = new int[numberOfNonzeroEntries];
            double[] newValues = new double[numberOfNonzeroEntries];
    ...
    /** {@inheritDoc} */
    @Override
    public SparseVector saxpy(double scalar, makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        SparseVector resultVector;
        if (vector.type() == VectorType.SPARSE) {
            int[] newIndexes = new int[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
    ...
    /** {@inheritDoc} */
    @Override
    public SparseVector saxpyInPlace(double scalar, makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        if (vector.type() == VectorType.SPARSE) {
            int[] newIndexes = new int[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
            double[] newValues = new double[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
    ...
    /** {@inheritDoc} */
    @Override
    public SparseVector saxpyPlusConstant(double scalar, makina.math.matrix.Vector vector) {
    ...
    /** {@inheritDoc} */
    @Override
    public SparseVector saxpyPlusConstantInPlace(double scalar, makina.math.matrix.Vector vector) {
        if (vector.size() + 1 != this.size())
            throw new IllegalArgumentException("The provided vector size must be 1 less than the current vector size.");
        if (vector.type() == VectorType.SPARSE) {
            int[] newIndexes = new int[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries + 1];
    ...
    /** {@inheritDoc} */
    @Override
    public double inner(makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        double result = 0;
        if (vector.type() == VectorType.SPARSE) {
            int vector1Index = 0;
    ...
    /** {@inheritDoc} */
    @Override
    public double innerPlusConstant(makina.math.matrix.Vector vector) {
        if (vector.size() + 1 != this.size())
            throw new IllegalArgumentException("The provided vector size must be 1 less than the current vector size.");
        double result = 0;
        if (vector.type() == VectorType.SPARSE) {
    ...
    /** {@inheritDoc} */
    @Override
    public SparseVector hypotenuse(makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        SparseVector resultVector;
        if (vector.type() == VectorType.SPARSE) {
            int[] newIndexes = new int[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
    ...
    /** {@inheritDoc} */
    @Override
    public SparseVector hypotenuseInPlace(makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        if (vector.type() == VectorType.SPARSE) {
            int[] newIndexes = new int[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
            double[] newValues = new double[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
    ...
    /** {@inheritDoc} */
    @Override
    public SparseVector hypotenuseFast(makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        SparseVector resultVector;
        if (vector.type() == VectorType.SPARSE) {
            int[] newIndexes = new int[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
    ...
    /** {@inheritDoc} */
    @Override
    public SparseVector hypotenuseFastInPlace(makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        if (vector.type() == VectorType.SPARSE) {
            int[] newIndexes = new int[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
            double[] newValues = new double[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
     ...
     */
    @Override
    public SparseVector mapBiFunction(BiFunction<Double, Double, Double> function, makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        SparseVector resultVector;
        if (vector.type() == VectorType.SPARSE) {
            int[] newIndexes = new int[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
     ...
     */
    @Override
    public SparseVector mapBiFunctionInPlace(BiFunction<Double, Double, Double> function, makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        if (vector.type() == VectorType.SPARSE) {
            int[] newIndexes = new int[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
            double[] newValues = new double[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
     ...
     */
    @Override
    public SparseVector mapAdd(Function<Double, Double> function, makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        SparseVector resultVector;
        if (vector.type() == VectorType.SPARSE) {
            int[] newIndexes = new int[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
     ...
     */
    @Override
    public SparseVector mapAddInPlace(Function<Double, Double> function, makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        if (vector.type() == VectorType.SPARSE) {
            int[] newIndexes = new int[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
            double[] newValues = new double[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
     ...
     */
    @Override
    public SparseVector mapSub(Function<Double, Double> function, makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        SparseVector resultVector;
        if (vector.type() == VectorType.SPARSE) {
            int[] newIndexes = new int[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
     ...
     */
    @Override
    public SparseVector mapSubInPlace(Function<Double, Double> function, makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        if (vector.type() == VectorType.SPARSE) {
            int[] newIndexes = new int[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
            double[] newValues = new double[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
     ...
     */
    @Override
    public SparseVector mapMultElementwise(Function<Double, Double> function, makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        SparseVector resultVector;
        if (vector.type() == VectorType.SPARSE) {
            int[] newIndexes = new int[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
     ...
     */
    @Override
    public SparseVector mapMultElementwiseInPlace(Function<Double, Double> function, makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        if (vector.type() == VectorType.SPARSE) {
            int[] newIndexes = new int[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
            double[] newValues = new double[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
     ...
     */
    @Override
    public SparseVector mapDivElementwise(Function<Double, Double> function, makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        SparseVector resultVector;
        if (vector.type() == VectorType.SPARSE) {
            int[] newIndexes = new int[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
     ...
     */
    @Override
    public SparseVector mapDivElementwiseInPlace(Function<Double, Double> function, makina.math.matrix.Vector vector) {
        checkVectorSize(vector);
        if (vector.type() == VectorType.SPARSE) {
            int[] newIndexes = new int[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
            double[] newValues = new double[numberOfNonzeroEntries + ((SparseVector) vector).numberOfNonzeroEntries];
    ...
    /** {@inheritDoc} */
    @Override
    public Matrix outer(makina.math.matrix.Vector vector) {
        return null;
    }

    /** {@inheritDoc} */
    @Override
    public SparseVector gaxpy(Matrix matrix, makina.math.matrix.Vector vector) {
        return null;
    }

    /** {@inheritDoc} */
    @Override
    public SparseVector gaxpyInPlace(Matrix matrix, makina.math.matrix.Vector vector) {
        return null;
    }
     ...
     * well).
     */
    private class SparseVectorIterator implements Iterator<Element> {
        ...
        public Element next() {
            ...
            Element element = new Element(SparseVector.this.indexes[nextElementIndex],
    ...
    public boolean equals(Object object) {
        if (!(object instanceof makina.math.matrix.Vector))
            return false;
        if (object == this)
            return true;
