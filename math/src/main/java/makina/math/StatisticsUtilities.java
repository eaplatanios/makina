...
public class StatisticsUtilities {
    ...
    public static double mean(makina.math.matrix.Vector vector) {
    ...
    public static double variance(makina.math.matrix.Vector vector) {
    ...
    public static double standardDeviation(makina.math.matrix.Vector vector) {
